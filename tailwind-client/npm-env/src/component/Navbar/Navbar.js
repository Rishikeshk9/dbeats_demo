...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <div expand="lg" className={` w-max fixed top-0 ${darkMode && 'dark'} z-100`}>
        <div
          className={`pr-3 pt-20 bg-white w-22 shadow-sm z-50 h-screen fixed left-0 dark:bg-dbeats-dark-primary  dark:text-gray-100   `}
        >
