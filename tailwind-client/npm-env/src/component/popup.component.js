...
export default function PopUp() {
  return (
    <div className="z-500  text-right  ">
      <Menu as="div" className=" z-500   text-left">
        <div>
          <Menu.Button className="z-500 dark:hover:bg-dbeats-dark-secondary px-2 transition-all  justify-center w-full  py-2 text-sm font-medium hover:text-white   text-gray-600  rounded-full bg-opacity-20 hover:bg-opacity-30  ">
            <svg
              height="25"
              width="25"
        ...
        >
          <Menu.Items className="-z-1  fixed w-56  origin-top-left bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
