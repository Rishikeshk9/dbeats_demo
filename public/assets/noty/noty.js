  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var animationEndEvents = (exports.animationEndEvents =
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.Defaults =
          exports.Store =
          exports.Queues =
          exports.DefaultMaxVisible =
          exports.docTitle =
          exports.DocModalCount =
          exports.PageHidden =
            undefined;
        ...
        function getQueueCounts() {
          ...
          if (Queues.hasOwnProperty(queueName)) {
            ...
            Object.keys(Store).forEach(function (i) {
              if (
                Store[i].options.queue === queueName &&
                !Store[i].closed
              )
                count++;
            });
        ...
        function removeFromQueue(ref) {
          if (Queues.hasOwnProperty(ref.options.queue)) {
            var queue = [];
            Object.keys(Queues[ref.options.queue].queue).forEach(
              function (i) {
                if (
                  Queues[ref.options.queue].queue[i].id !== ref.id
                ) {
        ...
        function hasButtons(ref) {
          return !!(
            ref.options.buttons &&
            Object.keys(ref.options.buttons).length
          );
        }
        ...
        function findOrCreateContainer(ref) {
          if (ref.options.container) {
            ref.layoutDom = document.querySelector(
          ...
          if (ref.options.timeout) {
            if (ref.options.progressBar && ref.progressDom) {
              Utils.css(ref.progressDom, {
                transition:
                  'width ' + ref.options.timeout + 'ms linear',
                width: '0%',
              });
            }
        ...
        function closeFlow(ref) {
          ...
          if (
            ref.layoutDom.querySelectorAll('.noty_bar').length ===
              0 &&
            !ref.options.container
          ) {
          ...
          if (
            Utils.inArray(
              'docVisible',
              ref.options.titleCount.conditions,
            ) ||
            Utils.inArray(
              'docHidden',
              ref.options.titleCount.conditions,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var NotyButton = (exports.NotyButton = function NotyButton(
          ...
          this.id = attributes.id =
            attributes.id || Utils.generateID('button');
          this.cb = cb;
          ...
          _createClass(Push, [
            {
              ...
              value: function on(eventName) {
                ...
                if (
                  typeof cb === 'function' &&
                  this.listeners.hasOwnProperty(eventName)
                ) {
            ...
            },
            {
              ...
              value: function getPermissionStatus() {
                ...
                if (
                  ...
                  perm = window.external.msIsSiteMode()
                    ? 'granted'
                    : 'default';
                }
            ...
            },
            {
              ...
              value: function getEndpoint(subscription) {
                ...
                if (
                  subscriptionId &&
                  endpoint.indexOf(subscriptionId) === -1
                ) {
...
*/
            ...
            Enumerator$1.prototype._settledAt = function (
              state,
              i,
              value,
            ) {
            ...
            Enumerator$1.prototype._willSettleAt = function (
              promise,
              i,
            ) {
              var enumerator = this;
              ...
              },
              {
                ...
                value: function show() {
                  ...
                  if (this.options.killer === true) {
                    ...
                    typeof this.options.killer === 'string'
                  ) {
                    Noty.closeAll(this.options.killer);
                  }

                  var queueCounts = API.getQueueCounts(
                    this.options.queue,
                  );
                  ...
                  if (
                    Utils.inArray('click', this.options.closeWith)
                  ) {
                    Utils.addClass(
                      this.barDom,
                  ...
                  if (
                    Utils.inArray('button', this.options.closeWith)
                  ) {
                    Utils.addClass(
                      this.barDom,
            ...
            [
              {
                ...
                value: function closeAll() {
                  ...
                  Object.keys(API.Store).forEach(function (id) {
                    if (queueName) {
                      if (
                        API.Store[id].options.queue === queueName &&
                        API.Store[id].killable
                      ) {
                        API.Store[id].close();
                      }
